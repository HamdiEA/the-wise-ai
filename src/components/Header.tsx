...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-b from-black/80 via-black/60 to-black/40 backdrop-blur-xl shadow-2xl border-b border-amber-400/10 transition-all duration-300">
